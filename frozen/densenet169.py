...
- [Download pretrained densenet-169 model]
...
class DenseNet169:
    ...
    def __init__(self, data_format = 'channels_first', densenet_path = 'densenet169_weights_tf_dim_ordering_tf_kernels_notop.h5'):
    ...
    # build densenet-169 encoder
    def densenet169_encoder(self, features):
