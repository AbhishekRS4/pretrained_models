...
class ResNet34:
    ...
    def __init__(self, data_format = 'channels_first', training = True, resnet_path = 'resnet34_imagenet_1000_no_top.h5'):
    ...
    def _conv_layer(self, input_layer, name, strides = [1, 1, 1, 1]):
        ...
        W_init_value = np.array(self._weights_h5[name][hierarchy_name]['kernel:0']).astype(np.float32)
