...
class Xception:
    ...
    def __init__(self, data_format = 'channels_first', training = True, xception_path = 'xception_weights_tf_dim_ordering_tf_kernels_notop.h5'):
    ...
    def xception_encoder(self, features):
        ...
        self.stage1 = self._batchnorm_layer(self.stage1, name = 'block1_conv1_bn')
        ...
        self.stage1 = self._batchnorm_layer(self.stage1, name = 'block1_conv2_bn')
        ...
        self.stage2_residual = self._batchnorm_layer(self.stage2_residual, name = 'block2_conv1_bn')

        self.stage2 = self._separable_conv_layer(self.stage1, name = 'block2_sepconv1', weights_key = 'separableconvolution2d_1')
        self.stage2 = self._batchnorm_layer(self.stage2, name = 'block2_sepconv1_bn')
        ...
        self.stage2 = self._batchnorm_layer(self.stage2, name = 'block2_sepconv2_bn')
        ...
        self.stage3_residual = self._batchnorm_layer(self.stage3_residual, name = 'block3_conv1_bn')

        self.stage3 = self._separable_conv_layer(self.stage2, name = 'block3_sepconv1', weights_key = 'separableconvolution2d_3')
        self.stage3 = self._batchnorm_layer(self.stage3, name = 'block3_sepconv1_bn')
        ...
        self.stage3 = self._batchnorm_layer(self.stage3, name = 'block3_sepconv2_bn')
        ...
        self.stage4_residual = self._batchnorm_layer(self.stage4_residual, name = 'block4_conv1_bn')

        self.stage4 = self._separable_conv_layer(self.stage3, name = 'block4_sepconv1', weights_key = 'separableconvolution2d_5')
        self.stage4 = self._batchnorm_layer(self.stage4, name = 'block4_sepconv1_bn')
        ...
        self.stage4 = self._batchnorm_layer(self.stage4, name = 'block4_sepconv2_bn')
        ...
        for i in range(8):
            ...
            self.temp_layer = self._batchnorm_layer(self.temp_layer, name = prefix + 'sepconv1_bn' + str(12 + 3 * i))
            ...
            self.temp_layer = self._batchnorm_layer(self.temp_layer, name = prefix + 'sepconv2_bn' + str(13 + 3 * i))
            ...
            self.temp_layer = self._batchnorm_layer(self.temp_layer, name = prefix + 'sepconv3_bn' + str(14 + 3 * i))
        ...
        self.stage13_residual = self._batchnorm_layer(self.stage13_residual, name = 'block13_conv1_bn')

        self.stage13 = self._separable_conv_layer(self.temp_layer, name = 'block13_sepconv1', weights_key = 'separableconvolution2d_31')
        self.stage13 = self._batchnorm_layer(self.stage13, name = 'block13_sepconv1_bn')
        ...
        self.stage13 = self._batchnorm_layer(self.stage13, name = 'block13_sepconv2_bn')
        ...
        self.stage14 = self._batchnorm_layer(self.stage14, name = 'block14_sepconv1_bn')
        ...
        self.stage14 = self._batchnorm_layer(self.stage14, name = 'block14_sepconv2_bn')
    ...
    def _conv_layer(self, input_layer, name, weights_key, strides = [1, 1, 1, 1]):
        W_init_value = np.array(self._weights_h5[weights_key][weights_key + '_W:0'], dtype = np.float32)
    ...
    def _separable_conv_layer(self, input_layer, name, weights_key, strides = [1, 1, 1, 1]):
        W_depthwise_init_value = np.array(self._weights_h5[weights_key][weights_key + '_depthwise_kernel:0'], dtype = np.float32)
        W_pointwise_init_value = np.array(self._weights_h5[weights_key][weights_key + '_pointwise_kernel:0'], dtype = np.float32)

        W_depthwise = tf.get_variable(name = name + '_depthwise_kernel', shape = W_depthwise_init_value.shape, initializer = tf.constant_initializer(W_depthwise_init_value), dtype = tf.float32)
        W_pointwise = tf.get_variable(name = name + '_pointwise_kernel', shape = W_pointwise_init_value.shape, initializer = tf.constant_initializer(W_pointwise_init_value), dtype = tf.float32)
